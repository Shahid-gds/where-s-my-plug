        ...
        <div class="overflow-hidden pt-[10rem]">
         ...
         <div class="flex justify-center px-6">
            <div class="text-center">
                <h1 class="font-[Jost-ExtraBold] md:text-[30px] text-[20px] text-[#61c1b4] uppercase">WHAT WOULD YOU?</h1>
                <h1 class="font-[Jost-ExtraBold] md:text-[50px] text-[30px] text-[#000000]">Like To Learn About</h1>
            </div>
         </div>
...
<script setup>
import LearnAboutCards from '@/components/layout/UI/LearnAboutCards.vue'
</script>