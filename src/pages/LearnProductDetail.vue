        ...
        <div class="container mx-auto sm:-mt-[15rem] -mt-[10rem] px-[8rem]">
            <div class="sm:flex items-center sm:space-x-16 justify-center w-full p-4 rounded-xl">
                ...
                <div class="w-full border-2 p-2 rounded-2xl  bg-[white] relative">
                    <!-- previous button -->
                    <div v-if="card.id !== '1'"  class="bg-[#61c1b4] p-3 rounded-r-full text-white absolute left-0 top-[10rem] cursor-pointer hover:bg-[#998a8a] transition-all duration-150"
                        @click="prevImage">
                    ...
                    <!-- next button -->
                    <div v-if="card.id !== '1'"  class="bg-[#61c1b4] p-3 rounded-l-full text-white absolute right-0 top-[10rem] cursor-pointer hover:bg-[#998a8a] transition-all duration-150"
                        @click="nextImage">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
            ...
            <div class="flex space-x-4 -mt-[4rem] px-4">
                <!-- Related images -->
                <div v-if="card.id !== '1'" v-for="(image, index) in card.relatedImages" :key="index"
    ...
    const cards = [
        {
            ...
            subHeading: ' Liquid Live Resin Cartridge',
            price: '25.99',
            weight: '20ct',
            type: 'Hybrid',
            thc: '100mg (5mg each)',
