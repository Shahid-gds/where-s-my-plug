    ...
    <section class="sm:pb-[20rem] pb-[15rem]">
        <div class="bg-covers bg-center bg-[url('@/assets/images/bgs/FooterBg.svg')] w-full p-6">
            <div class="container mx-auto py-[12rem] text-center">
                <div class="text-[#010101]  sm:text-[50px] text-[30px] font-[Jost-ExtraBold]">
                    {{ card.heading }}
                </div>
                <div class="text-[#61c1b4] sm:text-[30px] text-[25px] font-[Jost-SemiBold] relative">{{
                    card.subHeading }}
                </div>
            </div>
        </div>
...
const getCardById = async (id) => {
    const cards = [
        {
            id: '1',
            img1: import('../assets/images/LearnAboutCard/Img1.svg').then(module => module.default),
            img2: import('../assets/images/LearnAboutCard/Img2.svg').then(module => module.default),
            img3: import('../assets/images/LearnAboutCard/Img3.svg').then(module => module.default),
            img4: import('../assets/images/LearnAboutCard/Img4.svg').then(module => module.default),
            heading: 'Regernative',
            ...
            subHeading: 'Regernative | Blueberry crumble | Live suga',
            price: '25',
            rating: '5.0',
            ratingQty: '(120)',
            weight: '7g',
        ...
        {
            id: '2',
            img1: import('../assets/images/LearnAboutCard/Img2.svg').then(module => module.default),
            img2: import('../assets/images/LearnAboutCard/Img3.svg').then(module => module.default),
            img3: import('../assets/images/LearnAboutCard/Img1.svg').then(module => module.default),
            img4: import('../assets/images/LearnAboutCard/Img4.svg').then(module => module.default),
            heading: 'Regernative',
            stars: import('../components/icons/star.svg').then(module => module.default),
            leaf: import('../components/icons/drugLeaf.svg').then(module => module.default),
            backgroundColor: '#ebb22d',
            subHeading: 'Regenerative | Bubba OG | Live Badder',
            price: '25',
            rating: '5.0',
            ratingQty: '(120)',
            weight: '7g',
        ...
        {
            id: '3',
            img1: import('../assets/images/LearnAboutCard/Img3.svg').then(module => module.default),
            img2: import('../assets/images/LearnAboutCard/Img1.svg').then(module => module.default),
            img3: import('../assets/images/LearnAboutCard/Img4.svg').then(module => module.default),
            img4: import('../assets/images/LearnAboutCard/Img2.svg').then(module => module.default),
            heading: '253 Farmacy',
            stars: import('../components/icons/star.svg').then(module => module.default),
            leaf: import('../components/icons/drugLeaf.svg').then(module => module.default),
            backgroundColor: '#ebb22d',
