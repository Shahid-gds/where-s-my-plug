<template>
  ...
  const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/CommercialTermsHeroSection.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/CommercialTermsMergedSection.vue').then(m => m.default), { lazy: true }) },
  ];
  setTimeout(() => {
