...
const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/CareersHeroSection.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/JobsBaord.vue').then(m => m.default), { lazy: true }) },
    { name: 'QualityProductsBg', class: 'QualityProductsBg', component: defineAsyncComponent(() => import('../views/JobsQalityDispensaries.vue').then(m => m.default), { lazy: true }) },
