...
const sections = [
  { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/MyReviewHeroSection.vue').then(m => m.default), { lazy: true }) },
  { name: '', class: '', component: defineAsyncComponent(() => import('../views/MyReviewCards.vue').then(m => m.default), { lazy: true }) },
];
setTimeout(() => {
