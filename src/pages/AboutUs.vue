<template>
  ...
  const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/AboutUsHeroSection.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/AboutUsWelcomeSection.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/AboutUsMergedSection.vue').then(m => m.default), { lazy: true }) },
    ...
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/AboutGetAns.vue').then(m => m.default), { lazy: true }) },
  ...
  <style scoped>
  .HomeHeroBg {
    background: url("../assets/images/bgs/AboutUsHeroSectionBg.svg#svgView(preserveAspectRatio(none))") center center no-repeat;
