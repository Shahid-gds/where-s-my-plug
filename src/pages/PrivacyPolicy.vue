<template>
  ...
  const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/PrivacyPolicyHeroSection.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/PrivacyPolicyMergedSection.vue').then(m => m.default), { lazy: true }) },
  ];
  setTimeout(() => {
