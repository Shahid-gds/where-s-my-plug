<template>
  ...
  const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/CheckOutThankYouHero.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/CheckOutThankYouFlagSection.vue').then(m => m.default), { lazy: true }) },
  ];
  setTimeout(() => {
