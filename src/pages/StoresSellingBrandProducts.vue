...
const sections = [
    { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/StoresForSellingBrandProducts.vue').then(m => m.default), { lazy: true }) },
    { name: '', class: '', component: defineAsyncComponent(() => import('../views/StoreSellingProductsCategories.vue').then(m => m.default), { lazy: true }) },
];
setTimeout(() => {
