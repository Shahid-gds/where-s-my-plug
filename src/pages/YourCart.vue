...
const sections = [
  { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/YourCartHeroSection.vue').then(m => m.default), { lazy: true }) },
  { name: '', class: '', component: defineAsyncComponent(() => import('../views/YourCartItems.vue').then(m => m.default), { lazy: true }) },
  { name: '', class: '', component: defineAsyncComponent(() => import('../views/CannabisStrainsSection.vue').then(m => m.default), { lazy: true }) },
  ...
  { name: '', class: '', component: defineAsyncComponent(() => import('../views/CartWelcomeCarousel.vue').then(m => m.default), { lazy: true }) },
];
setTimeout(() => {
