...
const sections = [
  { name: 'HomeHeroBg', class: 'HomeHeroBg', component: defineAsyncComponent(() => import('../views/MyOrderDetailsHero.vue').then(m => m.default), { lazy: true }) },
  { name: '', class: '', component: defineAsyncComponent(() => import('../views/MyOrderDetailsById.vue').then(m => m.default), { lazy: true }) },
];
setTimeout(() => {
